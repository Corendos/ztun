...
pub fn main() anyerror!void {
    ...
    var server = ztun.Server.init(allocator, ztun.Server.Options{ .authentication_type = .long_term, .realm = "default" });
    defer server.deinit();

    // Add a Long-Term user
    try server.registerLongTermUser("corendos", "password");
